  ...
  return (
    ...
    <div>
      ...
      <main className="min-h-screen">
        ...
        <header className="w-full py-8 bg-gray-100 shadow-md">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            <h1 className="text-3xl font-bold text-primary">NotionHire</h1>
        ...
        <section className="flex flex-col items-center justify-center text-center py-20 bg-gradient-to-r from-gray-900 to-gray-400  px-6 md:px-0">
          <h2 className="text-4xl md:text-5xl font-bold text-white">Ace Your Next Interview with NotionHire</h2>
          <p className="mt-4 text-lg md:text-xl text-white ">Practice, perfect, and land your dream job with AI-powered interview coaching!</p>
      ...
      <footer className="py-8 bg-black text-white text-center">
        <p>© 2024 NotionHire. All rights reserved.</p>
      </footer>
    </div>
  )
}
